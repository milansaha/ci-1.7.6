<?php
	...
	echo form_open("po_divisions/$action",'',$hidden_input);
?>
<fieldset>	
		...
		<tr>
			...
			<td class="formTitleBar">
				<div style="float:right;">
					...
					<?php echo form_button(array('name'=>'button','id'=>'button','value'=>'true','type'=>'reset','content'=>'Cancel','class'=>'cancel_buttons','onclick'=>"window.location.href='".site_url('po_divisions')."'"));?>
				</div>
			</td>
		</tr>
		<tr>
