...
<fieldset>
	<!--<div id="execute_div">
		...
		<div id="execute_link">
			<?php echo anchor('loan_schedules/add',img(array('src'=>base_url().'/media/images/add.png','border'=>'0','alt'=>'Add Loan Shedules')).'Add Loan Shedule',array('class'=>'','title'=>'Add Loan Shedule'));  ?>
		</div>
	</div>-->
					...
					<td>
						<?php 
							if(isset($transcantions[$row["installment_number"]])){
								...
								echo anchor('loan_schedules/add_reschedules/'.$row['loan_id'].'/'.$row["installment_number"],img(array('src'=>base_url().'media/images/add.png','border'=>'0','alt'=>'Add Reschedule','width'=>'12px')).'&nbsp;&nbsp;<span style="color:#07A4E7;font-size:12px;font-weight:italic;">Reschedule</span>',array('class'=>'imglink','title'=>'Add Reschedule'));
							}
						?>
