...
echo form_open('saving_advance_registers/edit');
echo form_hidden('saving_advance_register_id',$row->id);
?>
<fieldset>
	<legend>
		Edit Saving Advance Register
	</legend>
	<ol>  
		<li>
...
<li> 
		...
		<li>
			...
			<?php echo form_input('txt_amount',set_value('txt_amount',$row->amount));?><?php echo form_error('txt_amount'); ?>
		</li> 
		<li>
                ...
                <?php
                        foreach($amount_types as $amount_type)
                         ...
                         echo form_dropdown('cbo_amount_type', $amount_types,$row->amount_type);
                ?>
                </li>
