...
<?php
	...
	//Form Start
	//echo form_open('saving_deposits/'.(isset($row->id)?"edit":"add"));
?>
<?php
		...
		<tr>
			...
			<td class="formTitleBar">
				<div style="float:right;">
					...
					<?php echo form_button(array('name'=>'button','id'=>'button','value'=>'true','type'=>'reset','content'=>'Cancel','class'=>'cancel_buttons','onclick'=>"window.location.href='".site_url('saving_deposits')."'"));?>
				</div>
			</td>
		</tr>
		<tr>
				...
				<div class="formContainer">
					<ol>  
						...
						<li>
							...
							<div class="form_input_container">
							<?php echo form_dropdown('cbo_savings_code',$savings_options,set_value('cbo_savings_code',(isset($row->savings_id)?$row->savings_id:"")),'id="cbo_savings_code"','class=> "input_select"');?><?php echo form_error('cbo_savings_code'); ?>
							</div>
						</li>		
						<li>			
							<label for="cbo_payment_type">Payment Type:<span class="required_field_indicator">*</span></label>
							<?php echo form_dropdown('cbo_payment_type', $payments,set_value('cbo_payment_type',(isset($row->mode_of_payment)?$row->mode_of_payment:"")),'id="cbo_payment_type"','class=> "input_select"');?><?php echo form_error('cbo_payment_type'); ?>
