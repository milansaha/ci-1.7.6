...
<?php
	...
	echo form_open("loan_reschedules/$action",'',$hidden_input);
		...
		<tr>
			...
			<td class="formTitleBar">
				<div style="float:right;">
					...
					<?php echo form_button(array('name'=>'button','id'=>'button','value'=>'true','type'=>'reset','content'=>'Cancel','class'=>'cancel_buttons','onclick'=>"window.location.href='".site_url('loan_reschedules')."'"));?>
				</div>
			</td>
		</tr>
		<tr>
				...
				<div class="formContainer">
					<ol>  
						...
						<li>
							...
							<div class="form_input_container">
							<?php echo form_input(array('name' => 'date_to','id' => 'date_to','class'=>'date_picker input_textbox','maxlength'=>'100','readonly'=>'readonly','value'=>$date_to));?>
							<div class="hints"> YYYY-MM-DD</div>
