<?php
	...
	echo form_open("educational_qualifications/$action",'',$hidden_input);
?>
<fieldset>
		...
		<tr>
			...
			<td class="formTitleBar">
				<div style="float:right;">
					...
					<?php echo form_button(array('name'=>'button','id'=>'button','value'=>'true','type'=>'reset','content'=>'Cancel','class'=>'cancel_buttons','onclick'=>"window.location.href='".site_url('educational_qualifications')."'"));?>
				</div>
			</td>
		</tr>
		<tr>
