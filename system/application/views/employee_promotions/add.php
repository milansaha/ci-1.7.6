...
<?php 
	...
	echo form_open('employee_promotions/add');
			...
			<td width="60%">
				...
				<ol>  
					...
					<li>	
						...
						<?php echo form_input(array('id'=>'old_designation_name', 'name'=>'txt_old_designation_name', 'readonly'=>'readonly','maxlength'=>'100','class'=>'input_textbox'),set_value('txt_old_designation_name',(isset($row->old_designation_id)?$new_designation_options[$row->old_designation_id]:"")));?><?php echo form_error('txt_old_designation_name'); ?>
	<input type="hidden" name="txt_old_designation_id" id="old_designation_id" 
	value="<?php echo isset($row->old_designation_id)?$row->old_designation_id:""?>"/> 
					...
					<li>	
						...
						<div class="form_input_container">
						<?php echo form_dropdown('cbo_new_designation',$new_designation_options);?>
						<?php //echo anchor('employee_designations/add',img(array('src'=>base_url().'media/images/add.png','border'=>'0','alt'=>'Add Designation')),array('class'=>'addimglink','alt'=>'Add Designation','title'=>'Add Designation'));  ?>
						<div class="label_adder"><?php echo form_label(img(array('src'=>base_url().'media/images/add.png','border'=>'0','alt'=>'Add Designation','width'=>'12px')), 'add_designation', array('class'=>'addimglink','style'=>'border:none;','title'=>'Add Designation','onclick'=>"window.location.href='".site_url('employee_designations/add')."'"));?></div>
