		...
		<tr> 
			...
			<td>
				...
				<?php 
					...
					?>			
					<?php echo ($posted['ch_attendence'][$posted['member_id'][$i]]=='1')?'Yes':'No' ;?>
				<?php }else{?>
					----
				<?php }?>			
			</td> 							
		   ...
		   <!-- <td><?php //echo isset($posted['loan_due'][$i])?$posted['loan_due'][$i]:0;?></td>
			...
			<td><?php echo isset($posted['loan_due'][$posted['loan_id'][$i]])?($posted['loan_due'][$posted['loan_id'][$i]]-$posted['txt_loan_amount'][$posted['loan_id'][$i]]):'-';?></td>
			...
			<td><?php echo isset($posted['txt_loan_amount'][$posted['loan_id'][$i]])?$posted['txt_loan_amount'][$posted['loan_id'][$i]]:'-';?></td> 
			...
			<td><?php echo isset($posted['txt_savings_amount'][$posted['savings_id'][$i]])?$posted['txt_savings_amount'][$posted['savings_id'][$i]]:'-';//($posted['txt_savings_amount'][$i] <= 0 )  ?'---':$posted['txt_savings_amount'][$i]?></td>
			<!--
