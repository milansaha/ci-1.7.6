...
<?php 
	...
	echo form_open('samity_employee_changes/add');	
				...
				<div class="formContainer">
					<ol>  
						...
						<li>	
							...
							<?php echo form_input(array('id'=>'old_field_officer', 'name'=>'txt_old_field_officer', 'readonly'=>'readonly'),set_value('txt_old_field_officer',(isset($row->old_field_officer_id)?$new_branch_options[$row->old_field_officer_id]:"")));?>
							<input type="hidden" name="txt_old_field_officer_id" id="old_field_officer_id" value="<?php echo isset($row->old_field_officer_id)?$row->old_field_officer_id:""?>"/> 
						...
						<li>	
							...
							<div class="form_input_container">
							<?php echo form_dropdown('cbo_new_field_officer', $employee_options,set_value('cbo_new_field_officer', (isset($row->employee_name)?$row->employee_name:"")),'calss="input_select"');?>
							<?php echo anchor('po_branches/add',img(array('src'=>base_url().'media/images/add.png','border'=>'0','alt'=>'Add Branch')),array('class'=>'addimglink','alt'=>'Add Branch','title'=>'Add Branch'));  ?>
						...
						<li>
							...
							<div class="form_input_container">
							<?php echo form_input(array('name' => 'txt_effective_date','id' => 'datepicker'),set_value('txt_effective_date'));?>
						...
						<li>
							...
							<div class="form_input_container">
							<?php echo form_textarea(array('name' => 'txt_comments','id' => 'txt_comments','calss'=>" input_textarea",'maxlength'=>"200",'rows'=> '1','cols'=>'8','style'=>'width:277px;height:50px;'),set_value('txt_comments',isset($row->comments)?$row->comments:""));?>
