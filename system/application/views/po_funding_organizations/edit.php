...
echo form_open('po_funding_organizations/edit');
echo form_hidden('po_funding_organization_id',$row->id);
			...
			<td width="60%">
				...
				<ol>  
					<li>
						...
						<?php echo form_input(array('name'=>'txt_name','class'=>'input_textbox','maxlength'=>'100'),set_value('txt_name',$row->name));?><?php echo form_error('txt_name'); ?>
						</div>
					</li> 
					<li>
						<label for="txt_concern_person">Concern Person:<span class="required_field_indicator">*</span></label>
						<div class="form_input_container">
						<?php echo form_input(array('name'=>'txt_concern_person','class'=>'input_textbox','maxlength'=>'100'),set_value('txt_concern_person',$row->concern_person));?><?php echo form_error('txt_concern_person'); ?>
						</div>
					</li>  
							<li>
						<label for="txt_address">Address:<span class="required_field_indicator">*</span></label>
						<div class="form_input_container">
						<?php echo form_input(array('name'=>'txt_address','class'=>'input_textbox','maxlength'=>'255'),set_value('txt_address',$row->address));?><?php echo form_error('txt_address'); ?>
						</div>
					</li>	
					<li>
						<label for="txt_land_phone">Phone:</label>
                        <div class="form_input_container">
						<?php echo form_input(array('name'=>'txt_land_phone','class'=>'input_textbox','maxlength'=>'20'),set_value('txt_land_phone',$row->land_phone));?><?php echo form_error('txt_land_phone'); ?>
                        </div>
                    </li>
					<li>
						<label for="txt_mobile_phone">Mobile:<span class="required_field_indicator">*</span></label>
						<div class="form_input_container">
						<?php echo form_input(array('name'=>'txt_mobile_phone','class'=>'input_textbox','maxlength'=>'20'),set_value('txt_mobile_phone',$row->mobile_phone));?><?php echo form_error('txt_mobile_phone'); ?>
						</div>
					</li>	
					<li>
						<label for="txt_email">Email:</label>
                        <div class="form_input_container">
						<?php echo form_input(array('name'=>'txt_email','class'=>'input_textbox','maxlength'=>'100'),set_value('txt_email',$row->email));?><?php echo form_error('txt_email'); ?>
                        </div>
					</li>
				</ol>
				</div>
