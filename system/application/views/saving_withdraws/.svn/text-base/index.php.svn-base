...
<?php 
	...
	?>
<?php echo form_open('saving_withdraws/index',array('id'=>'search_form','name'=>'search_form')); ?>
<div id="filter">
	<table style="padding:0px;" cellspacing="0px" cellpadding="0px" border="0" class="filter">
		<tr>
			<td>
                <?php $attribute = 'class="search_input" title="By Member Code"';?>
	...
	<div style="border:solid 0px red;float:right;width:auto;" class="buttons">
		<?php echo anchor('saving_withdraws/add',img(array('src'=>base_url().'/media/images/add.png','border'=>'0','alt'=>'Add Saving Withdraws')).'Add',array('class'=>'addbutton','title'=>'Add Saving Withdraws'));  ?>
	</div>	
</div>
...
<table class="sortable" cellspacing="0px" cellpadding="0px">
	...
	<?php 
		$i=$counter;
		foreach ($saving_withdraws as $row):
		$i++;
	...
	<tr <?php if($i % 2 == 0){ echo 'class="evenrow";'; echo ' bgcolor="#fff"';}else{echo 'class="oddrow"';}?>>
		...
		<td><?php $transaction_type=$row->transaction_type; if($transaction_type == 'WIT'):  echo "Withdraw"; else: echo ""; endif;?></td>
		<td><?php echo $row->mode_of_payment;?></td>
		<td align="right"><?php echo $row->amount;?></td>		
		<td><?php if($row->is_authorized==0): echo $unauthorized; else: echo $authorized; endif;?></td>
		<td><?php if($row->is_authorized == 0):echo anchor('saving_withdraws/edit/'.$row->id,img(array('src'=>base_url().'media/images/edit.gif','border'=>'0','alt'=>'edit')),array('class'=>'imglink'));   ?>
			<?php echo anchor('saving_withdraws/delete/'.$row->id, img(array('src'=>base_url().'media/images/delete.gif','border'=>'0','alt'=>'edit')),
