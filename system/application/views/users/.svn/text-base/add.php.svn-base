				...
				<div class="formContainer">
					<ol>  
						<li>
							...
							<?php echo form_input(array('name'=>'txt_full_name','class'=>'input_textbox','maxlength'=>'100'),set_value('txt_full_name'));?><?php echo form_error('txt_full_name'); ?>
                            </div>
						</li> 
						<li>
							<label for="login">Login:<span class="required_field_indicator">*</span></label>
                            <div class="form_input_container">
							<?php echo form_input(array('name'=>'txt_login','class'=>'input_textbox','maxlength'=>'40'),set_value('txt_login'));?><?php echo form_error('txt_login'); ?>
                            </div>
						</li>
						<li>
							<label for="password">Password:<span class="required_field_indicator">*</span></label>
                            <div class="form_input_container">
							<?php echo form_password(array('name'=>'txt_password','class'=>'input_textbox','maxlength'=>'40'),set_value('txt_password'));?><?php echo form_error('txt_password'); ?>
                            </div>
						</li>
						<li>
							<label for="verify_password">Verify Password:<span class="required_field_indicator">*</span></label>
                            <div class="form_input_container">
							<?php echo form_password(array('name'=>'txt_verify_password','class'=>'input_textbox','maxlength'=>'40'),set_value('txt_verify_password'));?><?php echo form_error('txt_verify_password'); ?>
                            </div>
						</li>  
						<li>
							<label for="cbo_role_id">Role:<span class="required_field_indicator">*</span></label>
                            <div class="form_input_container">
							<?php echo form_dropdown('cbo_role_id', $user_role_options,set_value('cbo_role_id'),$select_class);?><?php echo form_error('cbo_role_id'); ?>
                            </div>
						</li>
						<li>
							<label for="cbo_default_branch_id">Default Branch:<span class="required_field_indicator">*</span></label>
                            <div class="form_input_container">
							<?php echo form_dropdown('cbo_default_branch_id', $user_default_branch_options,set_value('cbo_default_branch_id'),$select_class); ?>	<?php echo form_error('cbo_role_id'); ?>
                            </div>
						</li>
						<li>
							<label for="current_status">Current Status:<span class="required_field_indicator">*</span></label>
                            <div class="form_input_container">
							<?php echo form_dropdown('cbo_current_status',$current_status_options,set_value('cbo_current_status'),$select_class);?><?php echo form_error('cbo_current_status'); ?>
                            </div>
						</li>								
					</ol>
				</div>
