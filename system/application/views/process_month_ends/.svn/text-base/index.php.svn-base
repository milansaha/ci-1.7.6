...
<h2>Month end process</h2>
<div id="execute_div">
	<div id="execute_link">
		<?php echo ajax_anchor('#ajax_list','#loading',"process_month_ends/ajax_execute","Execute"); ?>
	</div>
</div>
<div id="filter">
	<?php 
	...
	echo ajax_form('process_month_ends/index','#ajax_list','#loading');?>
