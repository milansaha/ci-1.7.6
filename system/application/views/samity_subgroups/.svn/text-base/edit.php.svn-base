...
echo form_open('samity_subgroups/edit');
echo form_hidden('subgroup_id',$row->id);
				...
				<div class="formContainer">
					<ol> 		
						<li>
							...
							<?php echo form_dropdown('cbo_group', $group_options, $row->group_id,'calss="input_select"'); 	?>
						...
						<li>
							...
							<div class="form_input_container">
							<?php echo form_input('txt_name',set_value('txt_name', $row->name),'calss="input_inputbox"','maxlength="100"');?><?php echo form_error('txt_name'); ?>
							</div>
						</li> 
						<li>
							<label for="txt_subgroup_code">Subgroup Code:<span class="required_field_indicator">*</span></label>
							<div class="form_input_container">
							<?php echo form_input('txt_subgroup_code',set_value('txt_subgroup_code', $row->subgroup_code),'calss="input_inputbox"','maxlength="20"');?><?php echo form_error('txt_subgroup_code'); ?>
							</div>
						</li>
					</ol>
				</div>
