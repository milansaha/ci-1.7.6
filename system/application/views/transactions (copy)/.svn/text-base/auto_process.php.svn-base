...
<tr <?php if($i % 2 == 0){ echo 'class="evenrow";'; echo ' bgcolor="#fff"';}else{echo 'class="oddrow"';}?> >
	...
	<td align="center">
		...
		if(isset($samity_info->total_member)){
			echo anchor('transactions/auto_process_add/'.$samity_info->samity_id,img(array('src'=>base_url().'media/images/edit.gif','border'=>'0','alt'=>'auto process')),array('class'=>'imglink','title'=>'Auto process')); 
	    }else{
			echo 'No member !';
			}
	     ?>	
