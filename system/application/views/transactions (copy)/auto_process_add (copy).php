...
<fieldset>
	...
	<table class="auto_process" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			<td  colspan="2">&nbsp;</td>
			<td><input type="checkbox" id="ch_present_all" value="present_all" ></td>
			<td  colspan="4">&nbsp;</td>
		...
		if(isset($auto_process) and !empty($auto_process)){
			foreach($auto_process as $member_info)
			{
				...
				<td width="20px"><input type="checkbox" id="ch_attendence" class="ch_attendence" name="ch_attendence[]" value="1"></td>
	            <td width="50px"><?php echo empty($member_info->loan_id)?'---':$member_info->loan_id?></td>
			    <td width="30px"><?php echo ($member_info->installment_amount <= 0 ) ?'---':$member_info->installment_amount?></td>
	            <td width="30px"><?php //echo empty($member_info->loan_id)?'---':$member_info->loan_id?></td>
				<td width="30px"><?php //echo empty($member_info->loan_id)?'---':$member_info->loan_id?></td>
			    ...
			    <td width="8px">|</td>
				<td width="40px"><?php echo empty($member_info->savings_id)?'---':$member_info->savings_id?></td> 
				...
				<td width="10px"><input id="txt_skt_amount_<?php echo $row?>" name="txt_skt_amount[]" readonly="readonly" size="2" type="text" value="<?php echo isset($member_info->skt_amount)?$member_info->skt_amount:0; ?>"></td>
				</tr>
				<?php
				$row++;
			}
		...
		<?php //echo form_submit('submit','Save',$submit_disable);?>
