	...
	<table class="addForm" border="0" cellspacing="0px" cellpadding="0px" width="100%">
		<tr>
			<td class="formTitleBar">
				<div>
					<?php echo img(array('src'=>base_url().'media/images/add_big.png','border'=>'0','width'=>'24'))?>					
				...
				<div class="formContainer">
					<ol>  
						<li>
							...
							<?php echo form_input(array('name'=>'txt_role_name','class'=>'input_textbox','maxlength'=>'100'),set_value('txt_role_name'));?><?php echo form_error('txt_role_name'); ?>
                            </div>
						</li> 
						<li>
							<label for="role_description">Role Description:</label>
                            <div class="form_input_container">
							<?php echo form_input(array('name'=>'txt_role_description','class'=>'input_textbox','maxlength'=>'255'),set_value('txt_role_description'));?><?php echo form_error('txt_role_description'); ?>
                            </div>
						</li> 	
					</ol>
				</div>
