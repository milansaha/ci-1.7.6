<div class="scroll-report">
		...
		<table width="100%" border="0" cellspacing="0"> 
			<tr>
				...
				<tr>
		 			...
		 			<td class="align-left"><strong>:</strong><?php echo date('d F, Y',strtotime($d_date_from))." To ".date('d F, Y',strtotime($d_date_to));?></td>		 			
					<th class="align-left">Print Date</th>
		 			<td class="align-left"><strong>:</strong><?php echo date("j F, Y");?></td></tr></table>
	<center><h3>Part-A</h3></center>
	<table  width="100%" border="1" cellspacing="0">  
  		<tr>
			<th colspan="4"><div align="center">Field Officer ID : <?php if(isset($field_officer_info)) echo $field_officer_info->code?></div></th>
			<th colspan="11"><div align="center">Field Officer Name : <?php if(isset($field_officer_info)) echo $field_officer_info->name?></div></th></tr>
  		<tr>
			<th rowspan="2" width="3%"><div align="center">SL. No.</div></th>
			<th rowspan="2" width="6%"><div align="center">Samity Code</div></th>
			<th rowspan="2" width="8%"><div align="center">Samity Name</div></th>
		...
		<?php if(isset($branch_manager_report_data_beginning_week)):
			$i=0;	
			foreach($branch_manager_report_data_beginning_week as $row):?>
		<tr>
			<th><div align="center"><?php echo $i++;?></div></th>
			<th><div align="center"><?php echo $row['samity_code'];?></div></th>
			<th><div align="left"><?php echo $row['samity_name'];?></div></th>
	...
	<table  width="100%" border="1" cellspacing="0">  
		<tr>
			<th colspan="4"><div align="center">Field Officer ID : <?php if(isset($field_officer_info)) echo $field_officer_info->code?></div></th>
			<th colspan="13"><div align="center">Field Officer Name : <?php if(isset($field_officer_info)) echo $field_officer_info->name?></div></th></tr>
		<tr>
			<th colspan="17"><div align="center">For The Week </div></th></tr>
		<tr>
			<th rowspan="2" width="4%"><div align="center">Samity ID </div></th>
		...
		<?php if(isset($branch_manager_report_data_for_this_week)):
			$i=0;	
			foreach($branch_manager_report_data_for_this_week as $row):?>
		<tr>
			<th><div align="center"><?php echo $row['samity_code'];?></div></th>			
			<th><div align="center"><?php echo $row['member_no'];?></div></th>
			<th><div align="center"><?php echo $row['admission_member_no'];?></div></th>
			<th><div align="center"><?php echo $row['closing_member_no'];?></div></th>
			<th><div align="right"><?php echo number_format($row['savings'],'2','.',',');?></div></th>
			<th><div align="center"><?php echo $row['cum_disbursement_no'];?></div></th>
			<th><div align="right"><?php echo number_format($row['cum_loan_amount'],'2','.',',');?></div></th>
			<th><div align="center"><?php echo $row['cum_fully_paid_loan_disbursement_no'];?></div></th>
			...
			<th><div align="center"><?php echo $row['cum_exp_borrower'];?></div></th>
			<th><div align="right"><?php echo number_format($row['cum_exp_loan_amount'],'2','.',',');?></div></th>
			<th><div align="center"><?php echo $row['loan_recoverable_amount'];?></div></th>			
			<th><div align="right"><?php echo number_format($row['transaction_amount'],'2','.',',');?></div></th>
			<th><div align="right"><?php echo number_format($row['due'],'2','.',',');?></div></th>
			<th><div align="right"><?php echo number_format($row['advance'],'2','.',',');?></div></th>
			<th><div align="right"><?php echo number_format($row['recovery_total'],'2','.',',');?></div></th>
			<th><div align="right"><?php echo number_format($row['new_due'],'2','.',',');?></div></th></tr>
		<?php endforeach; endif;?>		
		<tr>
			<th>Total</th>
			<th colspan="2"><div align="center"><?php echo $i++;?></div></th> 
	...
	<?php if(isset($branch_manager_report_data_end_week)):
			$i=0;	
			foreach($branch_manager_report_data_end_week as $row):?>
		<tr>
			<th><div align="center"><?php echo $row['samity_code'];?></div></th>			
			<th><div align="center"><?php echo $row['member_no'];?></div></th>			
			<th><div align="right"><?php echo number_format($row['savings'],'2','.',',');?></div></th>
			...
			<th><div align="right"><?php echo number_format($row['current_loan_amount'],'2','.',',');?></div></th>
			<th><div align="right"><?php echo number_format($row['due'],'2','.',',');?></div></th>
			<th><div align="right"><?php echo number_format($row['overdue'],'2','.',',');?></div></th>
			<th><div align="right"><?php echo number_format($row['total_overdue'],'2','.',',');?></div></th>
			<th><div align="right"><?php echo number_format($row['total_outstanding'],'2','.',',');?></div></th></tr>
		<?php endforeach; endif;?>
		<tr>
			<th>Total</th>			
