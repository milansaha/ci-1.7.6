...
?>
<?php echo ajax_form_for_report('regular_and_general_reports/ajax_samity_wise_monthly_loan_and_savings_collection_sheet_reports','#report_container',null,array('onsubmit'=>'if(validate(this)==false) return false;'));?>
