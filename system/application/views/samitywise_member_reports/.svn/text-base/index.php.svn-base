<?php
	$samtiy_options['-1'] = 'All';
	foreach($samities as $samity_info)
	{
		$samtiy_options[$samity_info->id] = $samity_info->name;
	}
	echo ajax_form_for_report('samitywise_member_reports/ajax_get_members_info_by_samity','#report_container');
?>
<style>
...
<div style="border-bottom:solid 0px #dedede;width:100%;float:left;">
	...
	<table border="0" class="reportLayout" width="auto" cellspacing="0px" cellpadding="0">
		<tr>
			<td>
				<label for="cbo_branch">Samity:</label>
				<?php echo form_dropdown('cbo_samity', $samtiy_options); ?>
			</td>
			<td>
