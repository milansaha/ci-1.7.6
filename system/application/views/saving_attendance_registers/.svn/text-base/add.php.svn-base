...
echo form_open('saving_attendance_registers/add');
?>
<fieldset>
	<legend>
		Add Saving Attendance Register
	</legend>
	<ol>  
		<li>
		...
		<li>
			...
			<?php echo form_input('txt_attendance_status',set_value('txt_attendance_status'));?><?php echo form_error('txt_attendance_status'); ?>
		</li>  
		<li>
