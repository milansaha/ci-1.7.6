...
//Samity list
	...
	echo form_open('samity_day_changes/edit');
		...
		<tr>
			<td width="60%">
				<div class="formContainer">
					<ol> 	
						<li>	
							<label for="cbo_member">Samity Name:<span class="required_field_indicator">*</span></label>
							<div class="form_input_container">		
							<input type="hidden" name="samity_id" id="samity_id" 'calss="input_textbox"' value="<?php echo isset($row->samity_id)?$row->samity_id:""?>" />
							<input type="text" id="samity_info" value="<?php echo isset($row->samity_name)?$row->samity_name.' - '.$row->samity_code:""?>" />
							<?php echo form_error('samity_id'); ?>				
							<input type="hidden" name="old_samity_day" id="old_samity_day" value="<?php echo isset($row->previous_samity_day)?$row->previous_samity_day:""?>" />			
							<div><div id="samity_info1"></div></div></div>
						</li> 
						<li id='old_samity_day'>
							<label for="old_samity_day">Old Samity Day:<span class="required_field_indicator">*</span></label>
							<div class="form_input_container">
							<?php echo form_dropdown('old_samity_day', $samity_day_options,$row->previous_samity_day,'disabled="disabled"','calss="input_select"');?>
							</div>
						</li>
						<li>
							<label for="cbo_samity_day">New Samity Day:<span class="required_field_indicator">*</span></label>
							<div class="form_input_container">
							<?php echo form_dropdown('cbo_samity_day', $samity_day_options,$row->new_samity_day,'calss="input_select"');?>
							</div>
						</li> 
						<li>
							<label for="txt_effective_date">Effective Date:<span class="required_field_indicator">*</span></label>
							<div class="form_input_container">
							<?php echo form_input(array('name'=>'txt_effective_date','id'=>'txt_effective_date','class'=>'date_picker'),set_value('txt_effective_date',$row->effective_date));?>
