...
echo form_open('product_interest_rates/edit');
				...
				<div class="formContainer">
					<ol>  
						<li>
							...
							<?php 
								//print_r($pos);
								echo form_dropdown('cbo_product', $options_product_name,$row->product_id,'id="cbo_product"','calss="input_select"');?><?php echo form_error('cbo_product');?> 
							</div>	
						</li> 
						<li>
							<label for="txt_interest_provision_rate">Provision Interest Rate:<span class="required_field_indicator">*</span></label>
							<div class="form_input_container">
							<?php echo form_input(array('name'=>'txt_interest_provision_rate','id'=>'txt_interest_provision_rate','readonly'=>'readonly')
							,set_value('txt_interest_provision_rate',$row->interest_provision_rate));?><?php echo form_error('txt_interest_provision_rate');?>
							</div>
						</li>
						...
						<li>
							...
							<div class="form_input_container">
							<?php echo form_input('txt_interest_rate',set_value('txt_interest_rate',$row->interest_rate),'calss="input_textbox"');?>
						...
						<li>
							...
							<div class="form_input_container">
							<?php echo form_input(array('name'=>'txt_effective_date','id'=>'txt_effective_date','class'=>"date_picker"),set_value('txt_effective_date',$row->effective_date));?><?php echo form_error('txt_effective_date'); ?>
						...
						<li>
							...
							<div class="form_input_container">
							<?php echo form_input(array('name'=>'txt_end_date','id'=>'txt_end_date','class'=>"date_picker"),set_value('txt_end_date',$row->end_date));?><div class="hints"> YYYY-MM-DD</div>
