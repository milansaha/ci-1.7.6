...
<?php
    ...
    echo ajax_form_for_report('register_reports/ajax_member_cancellation_register_report','#report_container',null,array('onsubmit'=>'if(validate(this)==false) return false;'));
?>
