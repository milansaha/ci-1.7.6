...
<?php
	...
	//echo form_open('register_reports/loan_disbursement_master_report');
        echo ajax_form_for_report('register_reports/ajax_loan_disbursement_master_report','#report_container',null,array('onsubmit'=>'if(validate(this)==false) return false;'));
?>
